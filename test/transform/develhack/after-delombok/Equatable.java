class Equatable {
	...
	class Default {
		...
		public boolean equals(final java.lang.Object o) {
			...
			if (!(o instanceof Equatable.Default)) return false;
			...
			if (!java.util.Arrays.equals(this.array1, other.array1)) return false;
			if (!java.util.Arrays.deepEquals(this.array2, other.array2)) return false;
			return true;
		}
	...
	class EvaluateSuperclass extends Thread {
		...
		public boolean equals(final java.lang.Object o) {
			if (o == this) return true;
			if (!(o instanceof Equatable.EvaluateSuperclass)) return false;
