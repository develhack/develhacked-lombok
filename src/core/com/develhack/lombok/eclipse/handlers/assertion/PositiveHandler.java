...
public class PositiveHandler extends AbstractNumericalAssertionHandler<Positive> {
	...
	private static final char[] CHECK_METHOD_NAME = "checkPositive".toCharArray();
	private static final char[] CHECK_IF_NONNULL_METHOD_NAME = "checkPositiveIfNonnull".toCharArray();
